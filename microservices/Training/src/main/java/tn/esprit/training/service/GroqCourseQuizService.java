...
@Service
public class GroqCourseQuizService {

    private static final ObjectMapper MAPPER = new ObjectMapper();

    private final GroqClientService groq;

    public GroqCourseQuizService(GroqClientService groq) {
        this.groq = groq;
    }
    ...
    private static List<QuizQuestionDTO> parseQuestions(String raw) {
        ...
        try {
            String json = extractJsonArray(stripMarkdownFences(raw).trim());
